...
router.put("/users/:uId/state/:type", function (req, res) {
  ...
  User.findById(uId,function(err,data){
    ...
    User.updateOne({_id:uId},{mg_state:type.replace(/"/g,'')},function(err,data){
      // console.log(err);
      // console.log(data);
      // console.log();
...
router.post('/users/new',function(req,res){
   const {_id,email,mobile,gender,age,duty,time,office,watch} = req.body.data
  //  console.log(req.body);
  // console.log(_id);
  // console.log(time);
   
   User.updateOne({_id:_id},{email:email,mobile:Number(mobile),gender:gender,
  age:age,duty:duty,time:time,office:office,watch:watch,},function(err,data){
    //  console.log(err);
     console.log(data);
...
router.put("/patients/:uId/state/:type", function (req, res) {
  ...
  Patient.findById(uId,function(err,data){
    // console.log(typeof Boolean(type));
    Patient.updateOne({_id:uId},{mg_state:type.replace(/"/g,'')},function(err,data){
      // console.log(err);
      // console.log(data);
      // console.log();
...
router.post('/patients/new',function(req,res){
   const { _id,email,mobile,username,checkOffice,checkDoctor,checkType,orgin,room,ago,PPE,DFA,RPDE} = req.body.data
   console.log(req.body);
   console.log(_id);
   
   
   
   Patient.updateOne({_id:_id},{email:email,mobile:Number(mobile),username:username,checkOffice,checkDoctor,checkType,orgin,room,ago,PPE,DFA,RPDE},function(err,data){
     console.log(err);
     console.log(data);
